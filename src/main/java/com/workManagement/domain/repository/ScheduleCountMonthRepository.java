 ...
 */
@Repository
public interface ScheduleCountMonthRepository extends BaseRepository<ScheduleCountMonthDto, String> {
	...
	public List<ScheduleCountMonthDto> selectScheduleCountMonth(String ym, String year);
}
