 ...
 */
@Repository
public interface SchedulePreDayRepository extends BaseRepository<SchedulePreDayDto, Integer> {


	/**
	 * [Repository] 1日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の1日に該当する予定スケジュールをユーザごとに取得する<br>
	...
	public List<SchedulePreDayDto> selectSchedulePreDay1(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 2日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の2日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay2(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 3日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の3日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay3(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);

	/**
	 * [Repository] 4日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の4日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay4(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 5日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の5日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay5(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 6日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の6日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay6(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 7日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の7日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay7(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 8日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の8日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay8(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 9日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の9日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay9(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 10日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の10日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay10(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 11日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の11日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay11(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 12日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の12日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay12(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 13日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の13日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay13(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 14日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の14日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay14(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 15日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の15日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay15(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 16日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の16日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay16(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 17日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の17日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay17(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 18日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の18日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay18(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 19日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の19日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay19(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 20日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の20日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay20(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 21日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の21日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay21(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 22日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の22日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay22(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 23日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の23日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay23(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 24日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の24日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay24(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 25日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の25日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay25(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 26日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の26日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay26(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 27日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の27日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay27(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 28日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の28日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay28(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 29日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の29日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay29(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 30日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の30日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay30(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);


	/**
	 * [Repository] 31日目の予定スケジュール取得処理
	 *
	 * <p>
	 * 対象の年月の31日に該当する予定スケジュールをユーザごとに取得する<br>
	 * ただし、登録済みのスケジュールが1つもないときはEmptyとなる<br>
	 * その日付に登録されたユーザのみ取得される
	 *
	 * @param schedule dayのスケジュール検索時、絞り込みたい文字 (%1%)
	...
	public List<SchedulePreDayDto> selectSchedulePreDay31(String schedule, String schedule1, String schedule2, String schedule3, String schedule4, String schedule5, String schedule6, String schedule7, String replaceValue, String ym);
}
